    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        <motion.div
          ...
          className="w-12 h-12 border-4 border-yellow-500 border-t-transparent rounded-full shadow-glow"
        />
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-500 to-yellow-600 animate-pulse-glow">
                  Test Performance
                </h1>
                <p className="text-gray-300">Comprehensive test analysis and tracking</p>
              </div>
            </div>
            <div className="flex space-x-3">
              <button
                ...
                className={`flex items-center space-x-2 px-6 py-3 rounded-lg font-medium transition-all duration-200 ${
                  hasUnsavedChanges && !saving
                    ? 'bg-gradient-to-r from-green-500 to-green-600 text-white shadow-glow hover:shadow-lg'
              ...
              <button
                ...
                className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white px-6 py-3 rounded-lg hover:from-yellow-600 hover:to-yellow-700 transition-all duration-200 font-medium flex items-center space-x-2 shadow-glow hover:shadow-lg"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <motion.div
            ...
            className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg p-4 text-center hover:shadow-glow transition-all duration-300"
          >
          ...
          >
            <div className="flex items-center justify-center space-x-1">
              <span className="text-2xl font-bold text-white">{Math.round(stats.average)}%</span>
          ...
          >
            <div className="flex items-center justify-center space-x-1">
              <span className="text-2xl font-bold text-white">{Math.round(stats.best)}%</span>
          ...
          <motion.div
            ...
            className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg p-4 text-center hover:shadow-glow transition-all duration-300"
          >
            <div className="text-2xl font-bold text-white">{stats.fullLength}</div>
            <div className="text-sm text-gray-400">Full Length</div>
          </motion.div>
        </div>
              ...
              {[
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-all duration-200 ${
                    chartType === type
                      ? 'bg-gradient-to-r from-yellow-500 to-yellow-600 text-white shadow-glow'
                      : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                  }`}
                  title={label}
                >
            ...
            {filteredTests.map((test, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center justify-between p-4 border border-gray-600 bg-gray-700 rounded-lg hover:shadow-glow hover:bg-gray-600 transition-all duration-200"
                >
                  <div className="flex items-center space-x-4">
        ...
        {isFormOpen && (
          ...
          >
            ...
            >
              <h2 className="text-xl font-bold text-white mb-4">Add Test Result</h2>
              ...
              <form onSubmit={addTest} className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    className="w-full p-3 border border-gray-600 bg-gray-700 text-white rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent"
                  >
                ...
                <div className="flex space-x-3">
                  <button
                    type="submit"
                    disabled={saving}
                    className="flex-1 bg-gradient-to-r from-yellow-500 to-yellow-600 text-white py-3 rounded-lg hover:from-yellow-600 hover:to-yellow-700 transition-all duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2 shadow-glow"
                  >
                    {saving ? (
                      <>
                        <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
