...
import { MistiRankPredictionEngine, type MistiProfile } from '@/lib/misti-rank-prediction-engine'
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Misti's profile with REAL NEET 2025 data and current improvement
    ...
    const prediction = await MistiRankPredictionEngine.generatePrediction(mistiProfile, realTimeData)
